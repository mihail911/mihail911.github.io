...
I also built [Confetti AI](https://www.confetti.ai/), the premier educational platform for training the next generation of machine learning practitioners, which was acquired by [Towards AI](https://towardsai.net/p/news/towards-ai-announces-acquisition-of-confetti-ai-a-leading-platform-for-ai-interview-preparation).
...
- [Setting Up a Machine Learning Project](/posts/setting-up-a-machine-learning-project/) (>28K Views) with [accompanying starter template](https://github.com/mihail911/e2eml-cookiecutter)
...
- I'm a regular co-host on the [MLOps Community](https://mlops.community/) podcast, where we bring in ML and data industry leaders to get spicy takes on tooling and future trends. The MLOps community is the largest group of MLOps practitioners globally. A sample of some of our shows:
    ...
    - [Making MLFlow: Corey Zumar](https://www.youtube.com/watch?v=odEWCeYPZkU&ab_channel=MLOps.community) - A discussion with one of the maintainers of MLFlow, a leading OSS MLOps library from Databricks
