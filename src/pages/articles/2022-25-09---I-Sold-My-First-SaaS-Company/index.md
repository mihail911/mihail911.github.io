...
In this case, we went with [MicroAcquire](https://microacquire.com/) which although it's relatively new, had received great reviews from our friends. There are other such services founders might consider such as [Flippa](https://flippa.com/), [Empire Flippers](https://empireflippers.com/), and [Investors Club](https://investors.club/), though MicroAcquire had the best reputation in our survey. 
...
In the end, we felt the strongest resonance with Louie and his team from [Towards AI](https://towardsai.net/) who we met through MicroAcquire. 
...
From our initial connection on MicroAcquire, we had a handful of conversations with Towards AI diving into specifics of the business, usage numbers, and financial numbers. Then we signed an [LOI](https://www.investopedia.com/terms/l/letterofintent.asp), after which we did a deeper technical dive into Confetti's architecture and setup. 
